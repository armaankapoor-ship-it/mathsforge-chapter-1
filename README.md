...
```text
https://github.com/armaankapoor-ship-it/mathsforge-chapter-1
```

## What Is Included

- Topic notes for Relations and Functions
- Formula sheet
...
2. Create a new public repository named `mathsforge-chapter-1`.
